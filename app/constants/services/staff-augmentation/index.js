...
export const QUALITY = {
  ...
  data: [
    ...
    {
      imgUrl: '/assets/qa/manual.png',
      title: 'Manual Testing',
    },
    {
      imgUrl: '/assets/qa/regression.png',
      title: 'Regression Testing',
    },
    {
      imgUrl: '/assets/qa/usability.png',
...
export const PLATFORM = {
  ...
  data: [
    {
      imgUrl: '/assets/platform/shopify.png',
      title: 'Shopify Developers',
    },
    {
      imgUrl: '/assets/platform/devops.png',
...
export const VUE_DEVELOPER = {
  heroSection: {
    ...
    subtitle: 'Reasonable, Dedicated Experts for Your Business',
    description:
      'Explore the proficiency of our skilled Vue.js developers in enhancing your online presence. Whether you require tailor-made solutions or seamless migrations, our experienced professionals guarantee exceptional results for your projects.',
    listItems: [
      {
        id: 1,
        text: '100% Skilled and Certified Developers',
  ...
  vueDevelopmentServices: {
    title: 'Explore Our Range of Expert Vue.js Development Services Tailored to Your Needs',
    cardData: [
      {
        id: 1,
        imageSrc: '/assets/vue/web-development.svg',
        cardTitle: 'Innovative Vue.js Web Application Development',
        content:
          ' Harness the power of Vue.js in building intuitive, high-performance, and scalable web applications with our expert web application development services.',
      },
      {
        id: 2,
        imageSrc: '/assets/vue/app-development.svg',
        cardTitle: 'Swift Single Page App Development',
        content:
          'Experience unparalleled performance and lightning-fast response times with our single page app development services powered by Vue.js expertise.',
      },
      {
        id: 3,
        ...
        content:
          'Our Vue.js consultants deeply understand your business challenges and offer tailored front-end solutions to address your unique needs effectively.',
      },
      {
        id: 4,
        imageSrc: '/assets/vue/component-development.svg',
        cardTitle: 'Dynamic Vue.js Component Development',
        content:
          ' We specialize in building fully functional and reusable UI components for diverse web applications. Leverage our Vue.js component development services to expedite the development of feature-rich websites/applications.',
      },
      {
        id: 5,
        imageSrc: '/assets/vue/migration-service.svg',
        cardTitle: 'Seamless Vue.js Migration Services',
        content:
          'With our cutting-edge Vue.js development services, you can enjoy a smooth transition and equip your websites with the latest features to enhance user experience.',
      },
      {
        id: 6,
        imageSrc: '/assets/vue/support-maintenance.svg',
        cardTitle: 'Vue.js Application Support & Maintenance',
        content:
          'Enhance your websites or apps with additional features and functionalities as your requirements evolve. Keep them up-to-date as we offer you the latest Vue.js updates every now and then for optimal performance. ',
      },
    ],
  },
  ...
  ctaSection1: {
    onlyDesc: true,
    descp1: 'Hire Dedicated',
    colouredDescp: 'Vue.js Developers',
    descp2:
      'team based on your requirements. We provide various hiring engagement models tailored to meet the specific needs of your business.',
    ctaText: 'GET IN TOUCH',
    redirect: '/contact',
  ...
  whyChoose: {
    title: 'Why Hire Vue.js Developers from Primathon?',
    description:
      'At Primathon, our Vue.js developers are renowned for their expertise and dedication. With over 7 years of experience in Vue.js development, they have honed their skills in crafting scalable and high-performing Vue.js applications.Our developers stay updated with the latest Vue.js advancements and tools, ensuring your project is built using the most innovative solutions.Security is paramount in our development process. We implement robust measures to shield your Vue.js  applications against threats and vulnerabilities.We fine-tune your Vue.js applications for speed and efficiency, delivering exceptional user experiences within your project timeline and budget constraints.',
    listItems: [
      { id: 1, text: 'Experience 1.5X Faster Delivery' },
      { id: 2, text: 'Work at Your Time Zone' },
      { id: 3, text: 'Hassle-free communication' },
  ...
  vueDevelopmentStrategy: {
    ...
    cardData: [
      ...
      },
      {
        ...
        text: 'Planning and Design',
        description:
          'We create a comprehensive plan and design layout for your Vue.js  project, focusing on usability, scalability, and performance.',
      },
      {
        id: 3,
        text: 'Development and Testing',
        description:
          'Our expert Vue.js developers begin the development phase, implementing robust code and conducting rigorous testing to ensure functionality and reliability.',
      },
      {
        id: 4,
        text: 'Deployment and Launch',
        description:
          'Once development is complete, we deploy your Vue.js solution to the desired environment and ensure a smooth launch, minimizing downtime and disruptions.',
      },
      {
        id: 5,
        text: 'Monitoring and Support',
        description:
          'We provide ongoing monitoring and support services to ensure your Vue.js  solution operates smoothly, addressing any issues promptly and efficiently.',
      },
    ],
  },
  ...
  faqs: {
    ...
    cardData: [
      {
        id: 1,
        question: 'What qualifications and experience do your Vue.js developers have?',
        answer: [
          'Our Vue.js developers at Primathon possess extensive qualifications and experience in Vue.js development. They have a minimum of 5 years of experience in Vue.js development and are proficient in various Vue.js frameworks and libraries. Our developers hold degrees in computer science or related fields and have a proven track record of successfully delivering Vue.js projects.',
        ],
      },
      {
        id: 2,
        question: 'How do I hire Vue.js developers',
        answer: [
          'Hiring Vue.js developers from Primathon is a straightforward process. Simply reach out to us through our website or contact our hiring team directly. We will discuss your project requirements, provide you with suitable candidates, and guide you through the hiring process.',
        ],
      },
      {
        id: 3,
        question: 'Will I get post-app development support?',
        answer: [
          'Yes, we provide comprehensive post-app development support to ensure the smooth functioning of your Vue.js applications. Our team is available to address any issues, implement updates, and provide ongoing maintenance and support services to keep your Vue.js apps running smoothly.',
        ],
      },
      {
        id: 4,
        question: 'Can I hire a Vue.js developer for hourly or project-based tasks?',
        answer: [
          'Yes, we offer flexible hiring models, including hourly hiring and project-based hiring, to cater to your specific needs. Whether you need a Vue.js developer for short-term tasks or long-term projects, we can accommodate your requirements.',
        ],
      },
      {
        id: 5,
        question: 'Is there demand for Vue.js Developers?',
        answer: [
          'Yes, there is a high demand for Vue.js developers in the market. Vue.js has gained popularity for its simplicity, flexibility, and performance, making it a preferred choice for web development projects. Many companies are actively seeking skilled Vue.js developers to work on their projects.',
        ],
      },
      {
        id: 6,
...
export const BACKEND_DEVELOPER = {
  ...
  backendDevelopmentStrategy: {
    title: 'An Overview of Our BackendDevelopment Approach',
    imageSrc: '/assets/python/development-strategy.png',
    imageAlt: 'Development Strategy',
    cardData: [
      {
