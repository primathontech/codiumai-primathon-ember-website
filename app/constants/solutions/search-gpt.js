export const SEARCH_GPT = {
  heroSection: {
    ...
    listItems: [
      {
        id: 1,
        text: 'Efficient Document Summarization',
      },
      {
        id: 2,
        text: 'Accurate FAQ Summary Generation',
      },
      {
        id: 3,
      ...
      {
        id: 4,
        text: 'Advanced Semantic Understanding',
      },
    ],
  ...
  searchGptDevelopmentServices: {
    title: 'Discover the Standout Search GPT Features',
    cardData: [
      {
        id: 1,
        imageSrc: '/assets/vue/web-development.svg',
        cardTitle: 'FAQ Document Summaries',
        content:
          'Search GPT excels in generating concise FAQ summary generation, allowing users to quickly access relevant information without the need to sift through lengthy documents.',
      },
      {
        id: 2,
  ...
  specificationOfsearchGpt: {
    title: 'Technical Specifications of Search GPT',
    cardData: [
      {
        id: 1,
  ...
  enhanceDocument: {
    title: 'Enhance Document Workflow with AI-powered Search GPT',
    description:
      'Search GPT integrates AI seamlessly into workflows, automating tasks like long text summarization. It enhances efficiency by swiftly extracting key insights, improving document discovery, and decision-making. With Search GPT, businesses optimize workflows, staying ahead in a fast-paced environment.',
  },
  ...
  featuresOfPrimathonSearchGpt: {
    title: 'Why Choose Search GPT Solutions Provided by Primathon?',
    cardData: [
      {
        id: '1',
        cardTitle: 'Cutting-Edge Technology',
        content:
          'Powered by outstanding AI and machine learning algorithms, our Search GPT solution offers advanced document processing capabilities that deliver accurate and insightful results. Get exceptional text summarization using gen AI with our services.',
      },
      {
        id: '2',
        cardTitle: 'Comprehensive Solutions',
        content:
          'Search GPT provides a comprehensive suite of features, including document summarization, FAQ summary generation, and personalized content recommendations, catering to diverse document management needs.',
      },
      {
        id: '3',
        cardTitle: 'Security and Compliance',
        content:
          "With robust security measures and compliance with global data protection regulations, Primathon's Search GPT ensures the confidentiality and integrity of user data, prioritizing privacy and compliance.",
      },
      {
        id: '4',
        cardTitle: 'Ease of Integration',
      ...
      },
      {
        ...
        content:
          'Built on a scalable infrastructure, Search GPT can handle large volumes of documents and user requests with reliability and efficiency, ensuring consistent performance even as data volumes grow.',
      },
      {
        id: '6',
        cardTitle: 'User-Centric Approach',
        content:
          "Primathon's Search GPT is designed with the user in mind, offering intuitive interfaces and personalized experiences that enhance usability and satisfaction.",
      },
      {
        id: '7',
        cardTitle: 'Continuous Innovation',
        content:
          'Committed to staying at the forefront of AI technology, Primathon continuously innovates and updates Search GPT to deliver cutting-edge solutions that meet evolving document management needs.',
      },
    ],
  },
  ...
  faqs: {
    ...
    cardData: [
      {
        id: 1,
        question: 'What is Search GPT?',
        answer: [
          'Search GPT is an AI-powered document management solution that leverages advanced algorithms to summarize documents, generate FAQ summaries, and personalize content.',
        ],
      },
      {
        id: 2,
        question: 'How does Search GPT summarize documents?',
        answer: [
          'Search GPT uses natural language processing (NLP) techniques to analyze and extract key information from documents, producing concise summaries that capture the essence of the text.',
        ],
      },
      {
        id: 3,
        question: 'Can Search GPT handle different document formats?',
        answer: [
          'Yes, Search GPT supports various document formats, including PDF, DOCX, TXT, and more, ensuring compatibility with a wide range of file types.',
        ],
      },
      {
        id: 4,
        question: 'What languages does Search GPT support?',
        answer: [
          'Search GPT supports multiple languages, allowing users to analyze and summarize documents in their preferred language with ease.',
        ],
      },
      {
        id: 5,
        question: 'Can Search GPT be integrated with other systems or applications?',
        answer: [
          'Yes, Search GPT offers API integration options, allowing seamless integration with other systems or applications to enhance workflow efficiency and productivity.',
        ],
      },
    ],
  },
