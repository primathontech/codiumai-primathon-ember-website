export const AI_INTEGRATION = {
  heroSection: {
    gradientTitle: 'Get Seamless AI Integration',
    ...
    cardData: [
      {
        ...
        content:
          'We begin by conducting a thorough assessment of your current business processes, technology infrastructure, and AI readiness. Based on our findings, we develop a customized AI integration roadmap that outlines key objectives, milestones, and success metrics.',
      },
      {
        id: 2,
      ...
      },
      {
        ...
        content:
          'Leveraging state-of-the-art machine learning algorithms and AI frameworks, we develop custom AI models tailored to your specific business requirements. Whether you need predictive analytics for forecasting demand, image recognition for quality control, or virtual assistants for customer support, we have the expertise to bring your AI vision to life.',
      },
      {
        id: 4,
        ...
        content:
          'We understand that implementing AI solutions often requires integration with existing systems and workflows. Our team works seamlessly with your IT department to ensure smooth integration, minimizing disruption and maximizing ROI.',
      },
      {
        id: 5,
    ...
    cardData: [
      {
        ...
        cardTitle: 'Expertise',
        content:
          'Our team brings a wealth of experience and expertise in AI technologies, ensuring that you have access to the best minds in the industry.',
      },
      {
        id: '2',
        cardTitle: 'Customization',
        content:
          "We understand that every business is unique. That's why we take a tailored approach to AI integration, developing solutions that are specifically designed to meet your needs and objectives.",
      },
      {
        id: '3',
        cardTitle: 'Results-Driven',
        content:
          "Our goal is to deliver measurable results that drive business value and ROI. From increased efficiency and productivity to enhanced customer satisfaction and revenue growth, we're committed to helping you achieve your goals.",
      },
    ],
  },
    ...
    cardData: [
      {
        ...
        content:
          'Assessing your business goals and processes to identify opportunities for AI integration, and developing a strategic plan for implementation.',
      },
      {
        id: 2,
        ...
        content:
          'AI system integration with your existing data sources, such as databases, data warehouses, or third-party APIs, to ensure seamless data flow and accessibility for AI algorithms.',
      },
      {
        id: 3,
        ...
        content:
          'Building custom machine learning or deep learning models tailored to your specific business needs, and training them on relevant datasets.',
      },
      {
        id: 4,
        ...
        content:
          "Implementing AI models into your existing systems or workflows, whether it's on-premises or in the cloud, and ensuring compatibility and smooth integration with other software components.",
      },
      {
        id: 5,
        ...
        content:
          'Creating APIs (Application Programming Interfaces) to enable communication between your applications and AI services, allowing for real-time data processing and decision-making.',
      },
    ],
  },
  ...
  ctaSection: {
    ...
    description:
      'Ready to unlock the full potential of AI for your business? Contact us today to learn more about our AI integration services and how we can help you drive innovation, efficiency, and growth. With Primathon by your side, the possibilities are endless.',
    ctaText: 'Contact Us',
    redirect: '/contact',
    bgColor: '#21315B',
  },
