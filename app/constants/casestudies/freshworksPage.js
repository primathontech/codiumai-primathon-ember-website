export const FRESHWORKS_DATA = {
  heroSection: {
    companyLogo: '/assets/caseStudy/freshworksLogo.png',
    description:
      'Freshworks is one of the leading names in India when it comes to offering SaaS to clients. With custom software and easily scalable solutions, Freshworks makes it easy for clients across industries to delight their customers with the perfect solutions. Freshworks offers IT and Enterprise Service Management (including IT service management software solutions), Customer Engagement Solutions, and Customer Service (including Cloud based CRM solutions) and Support solutions, which is why they are the best business services SaaS company.',
    backgroundImage: '#',
  },
  ...
  challenges_Services_Section: {
    CHALLENGES_DATA: {
      ...
      ChallengeDescription:
        'The Client approached us with an exciting challenge: we needed to implement solutions that would appeal to a modern customer, while keeping in mind business objectives regarding scalability. This meant that any product created for the client would have to be as self-sufficient as possible, with minimal maintenance down the line. ',
      BriefTitle: '',
      BriefPoints: [
      ...
      monthsIcon: '/assets/svgs/monthsLogo.svg',
      months: '5 Months',
      countryLogo: '/assets/svgs/countryLogo.svg',
      countryName: 'India',
    },
      ...
      data: [
        {
          ...
          serviceName: 'Business Processes Optimising',
        },
        {
  ...
  getInTouchSection: {
    ...
    description: 'Get in touch to schedule a call.',
    buttonText: 'GET IN TOUCH',
    getinTouchBackground: '/assets/caseStudy/getinTouchBackground.png',
  },
